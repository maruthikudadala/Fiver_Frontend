...
//     <Navbar />
//       <Routes>
//         <Route path="/" element={<h1 className="text-center mt-10 text-2xl">Welcome to Freelancer Marketplace</h1>} />
//         <Route path="/register" element={<Register />} />
//         <Route path="/login" element={<Login />} />
//         <Route path="/freelancer/dashboard" element={<CreateGig />} />
...
//   const hideNavbarRoutes = ["/freelancer/dashboard", "/client/dashboard"];
